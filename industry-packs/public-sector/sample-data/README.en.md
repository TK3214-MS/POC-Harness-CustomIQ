...
`work-iq/` contains four items that refer to the same case and application: a SharePoint document, a Teams conversation, an Outlook email, and meeting notes. Register them in dedicated test accounts, and do not mix them with real citizen information.
